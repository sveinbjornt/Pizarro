...
//	ccFillPoly(whiteVertices, 4, YES);
	...
	{
		colorBar = [[CCTextureCache sharedTextureCache] textureForKey: @"manabar_green.png"];
		barTop = [[CCTextureCache sharedTextureCache] textureForKey: @"manabar_green_top.png"];
	}
	else
	{
		colorBar = [[CCTextureCache sharedTextureCache] textureForKey: @"manabar_red.png"];
		barTop = [[CCTextureCache sharedTextureCache] textureForKey: @"manabar_red_top.png"];
	}
	
	if (colorBar == nil || barTop == nil)
		NSLog(@"Manabar texture is nil");
